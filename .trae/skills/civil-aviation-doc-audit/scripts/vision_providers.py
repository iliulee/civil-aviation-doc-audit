...
支持 8 家主流 Vision API（7 家国产 + OpenAI），全部走 OpenAI 兼容接口。
...
支持的 Provider：
  ...
  │ hunyuan  │ 腾讯混元  │ HUNYUAN_API_KEY      │ hunyuan-vision         │
...
def main():
    parser = argparse.ArgumentParser(
        description="Vision API 统一配置层 — 支持 8 家主流 Vision API（qwen/doubao/glm/hunyuan/kimi/silicon/baidu/openai）",
    ...
    parser.add_argument(
        ...
        help="指定 Provider（如 qwen/doubao/glm/hunyuan/kimi/silicon/baidu/openai）",
    )
