...
├── SKILL.md                          # 主 Skill 文件（必读，v9.7.1，按场景路由组织，步骤 1~7 线性编号）
├── README.md                         # 本文件（v9.7.1）
├── PROJECT_SPEC.md                   # 项目规格说明（v9.7.1）
...
│   ├── rule_engine.py                # 【核心】规则引擎核心（v6.0，加载/匹配/求值/检查/报告）
