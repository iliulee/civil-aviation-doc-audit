...
|:---:|:---|:---|:---|:---|
| 🔴 **Fatal** | 致命 | 资料造假、数据矛盾无法解释、关键参数严重偏离设计 | 高程自洽失败 >2m、签字全空白、施工记录缺合计行且来源不明 | 暂停归档，追溯原始底稿，必要时现场取芯 |
...
| 五、逻辑一致性专项检查 | 铁律9十项子检查（含监理-施工方对照） | 审核报告 |
...
| 九、审核日志 | 审核时间、依据、OCR置信度、铁律触发、知识分区红线自检结果 | 审核日志 |
