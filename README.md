...
> 民航工程施工资料合规性审核 Skill v7.1
> 适用：MH/T 5078.1~5078.6-2024 系列 + CCAR-165-R1 + MH 5031-2025 等民航规范
> 五大专业全覆盖：场道 / 空管 / 助航 / 弱电 / 供油
> v7.1 核心特性：data-editor 精密仪表盘升级（诊断面板 + 文档树优化 + 状态分级 + 问题视图 + 批量应用建议值 + 精密仪表盘视觉）
...
│   ├── data-editor.html              # 【v7.1】Web 数据编辑器（精密仪表盘，诊断面板 + 文档树优化 + 状态分级 + 问题视图）
