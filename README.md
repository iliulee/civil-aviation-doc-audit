...
| 能力 | 说明 |
|------|------|
| **四阶段流水线**（v7.0） | 建数据底座 → 人工核对 → 正式审核 → 生成报告，阶段间硬闸门 |
...
| **data-editor三栏升级**（v7.0） | 文档树 + 表格/原文/图纸三 Tab，快捷键确认 |
